...
export default function VideoDescription() {
  ...
  return (
    <div className="absolute w-[vw] pt-[19%] pl-8 md:pl-20 no-scrollbar">
        <div>
            <h1 className="text-2xl md:text-4xl text-white font-bold">{newTitle ?  newTitle : title}</h1>
            <p className="text-white h-[9rem] w-1/3 mt-4 overflow-clip">{newDes ? newDes : des}</p>
        </div>
        <div className="hidden md:flex items-center gap-x-8 mt-6">
